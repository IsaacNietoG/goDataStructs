...
Vamos a implementar estos iterables usando canales, que es una característica de Go que, además, nos abrirá las puertas a que nuestras estructuras estén preparadas para ser concurrentes.
