...
\label{sec:org0637aa3}
Sección pendiente jajaj
\section{Genéricos}
\label{sec:org72bad54}
...
Todas las funciones que requieren de comparabilidad entre elementos han sido divididas en su variable original y su variable \emph{Func} conforme a lo discutido en la \hyperref[sec:orgc50a6d2]{sección correspondiente}.
