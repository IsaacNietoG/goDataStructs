...
\label{sec:org1ff1abb}
Sección pendiente jajaj
\section{Genéricos}
\label{sec:org110b7cb}
...
Todas las funciones que requieren de comparabilidad entre elementos han sido divididas en su variable original y su variable \emph{Func} conforme a lo discutido en la \hyperref[sec:org3327f01]{sección correspondiente}.
