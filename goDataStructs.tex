...
\label{sec:org1b9941e}
Sección pendiente jajaj
\section{Genéricos}
\label{sec:org8055c24}
...
Todas las funciones que requieren de comparabilidad entre elementos han sido divididas en su variable original y su variable \emph{Func} conforme a lo discutido en la \hyperref[sec:org5a1dc9a]{sección correspondiente}.
